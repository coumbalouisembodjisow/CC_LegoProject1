...
public class CosmosDBLayer {
	...
	private static final String CONNECTION_URL = EnvConfig.getCosmosDbUrl();
    private static final String DB_KEY = EnvConfig.getCosmosDbKey();
    private static final String DB_NAME = EnvConfig.getCosmosDbName();
